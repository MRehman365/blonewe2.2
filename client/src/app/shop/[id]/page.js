                  ...
                  <div className="relative aspect-square">
                    <Link href={`/product/${item._id}`} className="overflow-hidden">
                      <Image
                        ...
                        loading="lazy"
                        fill
                        className={`${viewMode === "grid" ? "object-contain h-[400px] w-auto overflow-hidden transition-transform duration-300 group-hover:scale-105" : "object-contain h-[200px] w-auto overflow-hidden transition-transform duration-300 group-hover:scale-105"}`}
                      />
                    </Link>
                    {item?.discount > 0 && (
